...
int main(int, char**){
  //VideoCapture cap("images/%00000630d.jpg");
  VideoCapture cap("/home/ffanin/hector_quadrotor_tutorial/src/cpp_test/src/out.avi"); // open the default camera
  ...
  while(cap.isOpened()){
    ...
    std::cout << vel.getMat(ACCESS_READ).at<float>(2) << std::endl;
